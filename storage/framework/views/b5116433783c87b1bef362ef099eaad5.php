...
<bodyservicesection class="flex flex-col items-center justify-center min-h-screen p-4">
    <section style="text-align:center;">
        ...
        <?php echo Content::where('section', 'Coursestitle')->value('content'); ?>

        <?php echo Content::where('section', 'Coursescontent')->value('content'); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-gray-800 p-6 rounded-lg shadow-lg">
                <div class="flex items-center mb-4">
                    ...
                    <h3 class="text-xl font-bold"><?php echo e($course->name); ?></h3>
                </div>
                <p class="text-gray-400"><?php echo e($course->description); ?></p>
    ...
    <Button style="color:white;background-color:#E7167E; padding: 10px 60px; border-radius:10px;margin-top:20px;">View
        More</Button>
</bodyservicesection><?php /**PATH C:\xampp\htdocs\newdigitalorra\resources\views/frontend/servicessection.blade.php ENDPATH**/ ?>