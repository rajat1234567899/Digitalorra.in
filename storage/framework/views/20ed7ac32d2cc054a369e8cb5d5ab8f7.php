...
?>
<?php echo aboutuscontents::where('section', 'Welcome')->value('content'); ?></div>

    <div class="about-text"><?php echo aboutuscontents::where('section', 'Aboutherocontent')->value('content'); ?></div>
...
</abouthero><?php /**PATH C:\xampp\htdocs\newdigitalorra\resources\views/frontend/aboutherosection.blade.php ENDPATH**/ ?>