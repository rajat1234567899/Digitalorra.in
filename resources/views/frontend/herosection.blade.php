...
<main>
  <section class="Hero">
    ...
    ?>
      ...
      <div class="Hero__title">{!!Content::where('section', 'educatedmind')->value('content')!!}</div>
      <div class="Hero__subtitle">{!!Content::where('section', 'Educatedmind_content')->value('content')!!}
      </div>
