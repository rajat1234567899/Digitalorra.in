<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/herocss.css') }}">
    <link rel="stylesheet" href="{{ asset('css\testimonials.css') }}">
    ...
    <script src="{{ asset('js/herojs.js') }}"></script>
...
@endphp
<title>{{ $seo->meta_title ?? 'Default Admin Title' }}</title>
