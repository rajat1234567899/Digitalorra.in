...
<body>
    <div class="flex h-screen">
        ...
        <img src="{{ asset('images/logo.png') }}" alt="Logo" style="background-color:white;">            
        <nav>
                <ul>
                    <li class="mb-4"><a href="{{ route('admin.dashboard') }}" class="block p-2 hover:bg-gray-700 rounded">Dashboard</a></li>
